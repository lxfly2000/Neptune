...
ModelSettingJson.prototype.getMotionDialog = function (name, n) {
    if (this.json[this.MOTION_GROUPS] === undefined ||
        this.json[this.MOTION_GROUPS][name] === undefined ||
        this.json[this.MOTION_GROUPS][name][n] === undefined ||
        this.json[this.MOTION_GROUPS][name][n][this.DIALOGUE] === undefined)
        return undefined;

    return this.json[this.MOTION_GROUPS][name][n][this.DIALOGUE];
};
